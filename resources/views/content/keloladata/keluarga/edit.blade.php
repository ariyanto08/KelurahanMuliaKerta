    ...
    <div class="row">
        <div class="col-md-12 mt-5">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="{{ url('admin/keluarga', $keluarga->no_kk) }}">
                        @method('PUT')
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" list="list_penduduk" style="width: 100%;"
                                        name="nik" onkeyup="cekId(this.value)">
