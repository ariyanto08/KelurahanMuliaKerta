                ...
                <div class="contact_section layout_padding_2">
                    <div class="container">
                        <div class="email_text">
                            <h1 class="about_taital" style="text-align: center;">Maklumat Pelayanan</h1>
                            <p class="about_text">Dengan ini kami seluruh karyawan dan karyawati kelurahan mulia kerta
                                kecamatan benua kayong kabupaten ketapang menyatakan sanggup menyelenggarakan pelayanan
                                pelayanan yang telah di terapkan dan apabila tidak menepati janji,kami bersedia menerima
                                sanksi,sesuai peraturan perundang undangan yang berlaku</p>
                        </div>
                    </div>
                </div>
            </div>
